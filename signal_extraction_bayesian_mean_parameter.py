...
for n_terms in terms_list:
    ...
    # plt.show()
    plt.savefig("corner_plot_{}_mean_parameters.png".format(n_terms))
    plt.close(fig)
...
plt.legend()
plt.savefig("residuals_std_vs_poly_terms_mean_of_parameters.png", dpi=900)
...
plt.legend()
plt.grid(True)
plt.savefig("perturbation_scale_factor_vs_poly_terms_mean_of_parameters.png", dpi=900)
